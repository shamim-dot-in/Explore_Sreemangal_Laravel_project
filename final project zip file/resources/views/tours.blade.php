                        ...
                        <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                            ...
                            <div class="table-responsive">
                                <table class="table text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row" class="text-start">Sreemangal Nature Escape</th>
                                            
                                            <td>
                                                <i class="bi-check-circle-fill">$40</i>
                                            </td>
                                            
                                            <td>
                                                <i class="bi-check-circle-fill">$50</i>
                                            </td>
                                            
                                            <td>
                                                <i class="bi-check-circle-fill">$60</i>
                                            </td>
                                            <td>
                                                @auth
                                                    <a href="{{ route('bookings.create', 1) }}" class="btn btn-success">
                                                        Book
                                                    </a>
                                                @else
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Adventure Sreemangal</th>
                                        ...
                                        <tr>    
                                            <th scope="row" class="text-start">Tea Capital Signature Tour</th>

                                            <td>
                                                <i class="bi-check-circle-fill">$20</i>
                                            </td>

                                            <td>
                                                <i class="bi-check-circle-fill">$30</i>
                                            </td>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Waterfall Explorer’s Trek</th>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Backpacker Budget Trip</th>
                                            ...
                                            <td>
                                                <i class="bi-check-circle-fill">$25</i>
                                            </td>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Nature & Wellness Retreat</th>
                                            ...
                                            <td>
                                                <i class="bi-check-circle-fill">$55</i>
                                            </td>
